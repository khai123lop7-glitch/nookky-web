      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.infoCol} data-nk-reveal="left" data-nk-delay="1">
          ...
          <div className={styles.contactPerks}>
            {/* Perk 1 */}
            <div className={styles.perk} data-nk-reveal data-nk-delay="2" data-nk-tilt>
            ...
            {/* Perk 2 */}
            <div className={styles.perk} data-nk-reveal data-nk-delay="3" data-nk-tilt>
              <div className={styles.perkIcon}>
                <svg
                  width="22"
                  height="22"
            ...
            {/* Perk 3 */}
            <div className={styles.perk} data-nk-reveal data-nk-delay="4" data-nk-tilt>
              <div className={styles.perkIcon}>
                <svg
                  width="22"
                  height="22"
        ...
        <div className={styles.formCol} data-nk-reveal="right" data-nk-delay="2" data-nk-tilt>
